...
// material
import { Navbar, Typography, Menu, MenuHandler, MenuList, MenuItem, Avatar, Tabs, TabsHeader, TabsBody, Tab, TabPanel } from "@material-tailwind/react";
...
export default function DVNavbar() {
  ...
  const menus = [
    ...
    },
    {
      title: "Users",
      path: "/users",
      key: ["/users", "/users/clients", "/users/myteam"],
      children: [
        {
          title: "Clients",
          path: "/clients",
  ...
  let currentNav = getItemFromArr(navbarTypes, 'path', currentUrl).type || {
    logoTitle: 'DeskVantage',
    subLogoTitle: '',
    hasBurger: false,
    hasMenu: false,
    ...
    <Navbar className="top-0 z-50 rounded-none fixed bg-white bg-opacity-100 border-white border-opacity-100 backdrop-saturate-0 backdrop-blur-none">
      <div className="flex justify-between">
        <div className="flex items-center">
          {currentNav.hasBurger && <RxHamburgerMenu className="text-custom-black text-2xl mr-8 cursor-pointer"/>}
          <span
            ...
            onClick={() => navigate("/")}
          >
            <img src="/image/favicon.png" alt="logo.png" className=" mr-2 w-[26px] h-[30px]" />
            {currentNav.logoTitle}
            {currentNav.subLogoTitle}
          </span>
          {currentNav.hasMenu && (isTablet === false ? (
        ...
        <div className="flex items-center gap-8 mr-4">
          ...
          {currentNav.hasSearchBox && (
            <div className=" flex items-end ">
              <DVSearchBox className="bg-[#F2F3F5] h-[50px] w-[450px]" hasSuffix={true} value={searchVal} onChange={setSearchVal} />
            </div>
          )}
