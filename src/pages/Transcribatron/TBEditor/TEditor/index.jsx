...
const TEditor = (props) => {
    ...
    return (
        <div className="grid">
            ...
            <div className={`sticky bg-white ${isFlex ? "top-[82px]" : "top-[310px]"} ${openFunctionBar ? "" : "hidden"} z-30`}>
                <div ref={funcBarRef} className={`bg-white flex justify-between py-4 px-10`} style={{"width" : functionBarWidth + 80 + "px"}}>
                ...
                <hr style={{ "width": functionBarWidth + "px" }} className={`ml-10 mb-2 bg-white w-full border-blue-gray-50`} />
            </div>
            <div ref={tBodyRef} className={`px-10`} style={{ maxWidth: mainMax + 80 + 'px', minWidth: mainMin + 80 + "px" }}>
                <TBody
