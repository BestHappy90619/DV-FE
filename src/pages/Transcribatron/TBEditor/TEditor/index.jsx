...
const TEditor = (props) => {
    ...
    const { toggleNote, toggleSearch, togglePlaylistSidebarPosition, toggleNoteSidebarPosition, toggleSearchSidebarPosition, playlistOrder, noteOrder, searchOrder } = props;
